---
title: I tracked the Patek 5711/1A across 13 dealer marketplaces for 30 days. The JP↔US spread holds at $44,300.
published: false
description: 30-day median price data for the Patek Philippe 5711/1A-010 across Chrono24, WatchBox, Bob's, Watchfinder, European Watch Co, Watches of Switzerland, The Watch Club, A Collected Man, Analog:Shift, H. Spliedt, Bachmann & Scher, and Yahoo Auctions Japan — plus the per-platform median table, P10-P90 ranges, and why the spread persists.
tags: watches, apify, scraping, arbitrage
canonical_url:
cover_image:
series:
---
...
- Code: github.com/DataKazKN/watch-arbitrage-mcp
- Try it free: apify.com/kazkn/watch-arbitrage-mcp
